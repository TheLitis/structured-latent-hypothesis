...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run hybrid structured candidates across the interaction ladder.")
    parser.add_argument("--output-dir", default="results/structured_hybrid_probe_v1")
...
def main() -> None:
    ...
    plot_metric(results, output_dir / "test_recon_vs_coupling.png", "test_recon_mse", "Hybrid structured candidates across coupling", "test recon mse")
