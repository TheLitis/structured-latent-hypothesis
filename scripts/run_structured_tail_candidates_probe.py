...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run structured interaction candidates on the strong-coupling tail.")
    parser.add_argument("--output-dir", default="results/structured_tail_candidates_v1")
    ...
    parser.add_argument("--alphas", type=float, nargs="+", default=[0.50, 0.75, 1.00])
    ...
    return {
        ...
        "additive_resid_selected": {
            ...
            "selection": {
                ...
                "candidates": selection_grid("additive_residual"),
            },
        },
        "lowrank_r4_selected": {
            ...
            "selection": {
                "metric": "test_recon_mse",
                "inner_train_fraction": float(args.inner_train_fraction),
                "candidates": selection_grid("additive_low_rank", interaction_rank=4),
            },
        },
        "interaction_mlp_r4_selected": {
            "model_type": "additive_interaction_mlp",
            "interaction_rank": 4,
            "selection": {
                "metric": "test_recon_mse",
                "inner_train_fraction": float(args.inner_train_fraction),
                "candidates": selection_grid("additive_interaction_mlp", interaction_rank=4),
            },
        },
        "operator_full_r2_selected": {
            "model_type": "additive_operator",
            "interaction_rank": 2,
            "selection": {
                "metric": "test_recon_mse",
                "inner_train_fraction": float(args.inner_train_fraction),
                "candidates": selection_grid("additive_operator", interaction_rank=2),
            },
        },
        "operator_diag_r2_selected": {
            "model_type": "additive_operator_diag",
            "interaction_rank": 2,
            "selection": {
                "metric": "test_recon_mse",
                "inner_train_fraction": float(args.inner_train_fraction),
                "candidates": selection_grid("additive_operator_diag", interaction_rank=2),
            },
        },
    }
...
def main() -> None:
    ...
    plot_metric(results, output_dir / "test_recon_vs_coupling.png", "test_recon_mse", "Structured candidates on the strong-coupling tail", "test recon mse")
    plot_metric(results, output_dir / "residual_norm_vs_coupling.png", "residual_norm_train", "Residual norm for structured candidates", "train residual norm")
