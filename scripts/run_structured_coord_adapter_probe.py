...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run structured backbone plus coordinate adapter candidates.")
    parser.add_argument("--output-dir", default="results/structured_coord_adapter_probe_v1")
...
def build_variant_recipes(args: argparse.Namespace) -> dict[str, dict]:
    return {
        ...
        "curv_hankel_coord_r4_selected": selected_recipe("additive_curvature_hankel_coord", 4, args.inner_train_fraction),
...
def main() -> None:
    ...
    plot_metric(results, output_dir / "test_recon_vs_coupling.png", "test_recon_mse", "Structured backbone plus coordinate adapter", "test recon mse")
